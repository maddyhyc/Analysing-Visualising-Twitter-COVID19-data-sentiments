...
# In the video I showed the example with data from Mar 29 - Mar 31 which I took out here
...
score_df <- cbind(sentiment = row.names(score_df), score_df, row.names=NULL)
...
library(tidyr)
score_df2 <- gather(score_df, 'mar29', 'mar30', 'mar31', 'apr1', 'apr2', 'apr3', 'apr4', 'apr5', 'apr6', 'apr7', 'apr8', 'apr9', 'apr10', 'apr11', key = "day", value = "score", na.rm = FALSE)
